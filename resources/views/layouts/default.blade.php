                        ...
                        <div class="left-navblock">
                            ...
                            @elseif ($snipeSettings->brand == '2')
                                <a class="logo navbar-brand no-hover" href="{{ config('app.url') }}">
                                    ...
                                    @endif
                                    <span class="sr-only">{{ Auth::user()->first_name }}</span>
                                </a>
                            @else
                                <a class="logo navbar-brand no-hover" href="{{ config('app.url') }}">
                                <img class="navbar-brand-img"
                                    ...
                                    <ul class="dropdown-menu">
                                        @can('create', \App\Models\Asset::class)
                                            <li {!! (Request::is('hardware/create') ? 'class="active>"' : '') !!}>
                                                ...
                                                <img 
                                                    src="{{config('app.url').'/img/icons/assets.svg'}}"
                                                    alt="{{ $snipeSettings->site_name }} logo">
                                                    <!-- <i class="fas fa-barcode fa-fw" aria-hidden="true"></i> -->
                                                    {{ trans('general.asset') }}
                                                </a>
                                        ...
                                        @can('create', \App\Models\Accessory::class)
                                            <li {!! (Request::is('accessories/create') ? 'class="active"' : '') !!}>
                                                ...
                                                <img 
                                                    src="{{config('app.url').'/img/icons/accessories.svg'}}"
                                                    alt="{{ $snipeSettings->site_name }} logo">
                                        ...
                                        @can('create', \App\Models\Consumable::class)
                                            <li {!! (Request::is('consunmables/create') ? 'class="active"' : '') !!}>
                                                ...
                                                <img 
                                                    src="{{config('app.url').'/img/icons/consumables.svg'}}"
                                                    alt="{{ $snipeSettings->site_name }} logo">
                                        ...
                                        @can('create', \App\Models\User::class)
                                            <li {!! (Request::is('users/create') ? 'class="active"' : '') !!}>
                                                ...
                                                <img 
                                                    src="{{config('app.url').'/img/icons/users.svg'}}"
                                                    alt="{{ $snipeSettings->site_name }} logo">
