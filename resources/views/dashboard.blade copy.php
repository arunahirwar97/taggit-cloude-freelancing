...
<div class="row">
  ...
  <div class="col-lg-2 col-xs-6">
    ...
    <div class="small-box bg-teal">
      ...
      <img src="{{config('app.url').'/img/icons/dashbaord/assets.svg'}}" alt="{{ $snipeSettings->site_name }} logo">
  ...
  <div class="col-lg-2 col-xs-6">
    ...
    <div class="small-box bg-maroon">
      <div class="inner">
        ...
        <p>{{ strtolower(trans('general.license')) }}</p>
      </div>
      <div class="icon" aria-hidden="true">
        <!-- <i class="far fa-save"></i> -->
      <img src="{{config('app.url').'/img/icons/dashbaord/software_licenses.svg'}}" alt="{{ $snipeSettings->site_name }} logo">
  ...
  <div class="col-lg-2 col-xs-6">
    ...
    <div class="small-box bg-orange">
      ...
      <div class="icon" aria-hidden="true">
      <img src="{{config('app.url').'/img/icons/dashbaord/accessories.svg'}}" alt="{{ $snipeSettings->site_name }} logo">
  ...
  <div class="col-lg-2 col-xs-6">
    ...
    <div class="small-box bg-purple">
      <div class="inner">
        ...
        <p>{{ strtolower(trans('general.consumable')) }}</p>
      </div>
      <div class="icon" aria-hidden="true">
        <!-- <i class="fas fa-tint"></i> -->
          <img src="{{config('app.url').'/img/icons/dashbaord/consumables.svg'}}" alt="{{ $snipeSettings->site_name }} logo">
  ...
  <div class="col-lg-2 col-xs-6">
   ...
   <div class="small-box bg-yellow">
     <div class="inner">
       ...
       <p>{{ strtolower(trans('general.component')) }}</p>
     </div>
     <div class="icon" aria-hidden="true">
       <!-- <i class="far fa-hdd"></i> -->
       <img src="{{config('app.url').'/img/icons/dashbaord/spares.svg'}}" alt="{{ $snipeSettings->site_name }} logo">
 ...
 <div class="col-lg-2 col-xs-6">
   ...
   <div class="small-box bg-light-blue">
     <div class="inner">
       ...
       <p>{{ strtolower(trans('general.users')) }}</p>
     </div>
     <div class="icon" aria-hidden="true">
       <img src="{{config('app.url').'/img/icons/dashbaord/users.svg'}}" alt="{{ $snipeSettings->site_name }} logo">
